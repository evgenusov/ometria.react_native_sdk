...
type OmetriaReactNativeSdkCoreType = {
     ...
     */
    initializeWithApiToken: (token: string, options?: OmetriaOptions) => Promise<void>;
    trackProfileIdentifiedByCustomerIdEvent: (customerId: string, storeId?: MaybeNull<string>) => void;
    trackProfileIdentifiedByEmailEvent: (email: string, storeId?: MaybeNull<string>) => void;
    /**
     ...
     */
    trackProfileIdentifiedEvent: (customerId: string, email: string, storeId?: MaybeNull<string>) => void;
    ...
    trackProductListingViewedEvent: (listingType: string, listingAttributes: object) => void;
    ...
    trackOrderCompletedEvent: (orderId: string, basket?: MaybeNull<OmetriaBasket>) => void;
    trackDeepLinkOpenedEvent: (link: string, screenName: string) => void;
    trackHomeScreenViewedEvent: () => void;
    trackScreenViewedEvent: (screenName: string, additionalInfo?: MaybeNull<object>) => void;
    trackCustomEvent: (customEventType: string, additionalInfo?: MaybeNull<object>) => void;
    flush: () => void;
    clear: () => void;
     ...
     */
    onNotificationOpenedApp: (notification: FirebaseMessagingTypes.RemoteMessage) => void;
    /**
     * Only for Android
     ...
     */
    onAndroidBackgroundMessage: (payload: OmetriaOnBackgroundMessagePayload) => Promise<void>;
    /**
     ...
     */
    onNotificationReceived: (remoteMessage: FirebaseMessagingTypes.RemoteMessage) => void;
    /**
     ...
     */
    parseNotification: (remoteMessage: FirebaseMessagingTypes.RemoteMessage) => Promise<OmetriaNotificationData | undefined>;
};
type OmetriaReactNativeSdkDeprecatedType = {
     ...
     */
    onNotificationInteracted(handler: (response: OmetriaNotificationData) => void): () => void;
    /**
     * Only for Android
     * @deprecated since version 2.4.0. Use the new method `onAndroidBackgroundMessage` to handle background messages.
     */
    setBackgroundMessageHandler(handler: OmetriaOnBackgroundMessagePayload): Promise<void>;
};
export type OmetriaReactNativeSdkType = OmetriaReactNativeSdkCoreType & OmetriaReactNativeSdkDeprecatedType;
